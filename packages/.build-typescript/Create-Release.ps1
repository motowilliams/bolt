...
<#
.SYNOPSIS
    Creates release archive for TypeScript starter package
.DESCRIPTION
    Packages the TypeScript starter package tasks into a zip file with checksum
...
# Extract starter name (e.g., ".build-typescript" -> "typescript")
