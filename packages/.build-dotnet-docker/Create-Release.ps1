...
<#
.SYNOPSIS
    Creates release archive for .NET starter package
.DESCRIPTION
    Packages the .NET starter package tasks into a zip file with checksum
...
# Extract starter name (e.g., ".build-dotnet" -> "dotnet")
