...
<#
.SYNOPSIS
    Creates release archive for Python starter package
.DESCRIPTION
    Packages the Python starter package tasks into a zip file with checksum
...
# Extract starter name (e.g., ".build-python" -> "python")
