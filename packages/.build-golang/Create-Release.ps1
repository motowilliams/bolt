...
<#
.SYNOPSIS
    Creates release archive for Golang starter package
.DESCRIPTION
    Packages the Golang starter package tasks into a zip file with checksum
...
Write-Host "Creating Golang starter package archive..." -ForegroundColor Cyan
...
# Extract starter name (e.g., ".build-golang" -> "golang")
...
Write-Host ""
Write-Host "✓ Golang starter package release completed successfully" -ForegroundColor Green
exit 0
