...
Describe 'Bicep Package Create-Release.ps1 Script Validation' -Tag 'Release', 'Package-Bicep-Tasks' {
    It 'Should exist and be a valid PowerShell script' {
...
Describe 'Bicep Create-Release.ps1 Functionality' -Tag 'Release', 'Package-Bicep-Tasks' {
    BeforeEach {
        $script:TempOutput = Get-TempTestPath
    }
